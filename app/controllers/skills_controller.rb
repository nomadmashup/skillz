...
class SkillsController < ApplicationController
  ...
  def faq
    ...
    @questions = [
      { question: "Who wrote this?", answer: "Programmed with care by <strong>james.trask@hp.com</strong>".html_safe },
      ...
      { question: "What information can other people see?", answer: "People in the section can see all your answers. Nobody else can." },
      ...
      { question: "When are my answers saved?", answer: "The moment you answer the question." },
      ...
      { question: "Why are you asking me for this information?", answer: "You are a valued team member."},
      ...
      { question: "How the heck did you put all this together?", answer: "With much meticulous care."},
