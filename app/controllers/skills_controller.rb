...
class SkillsController < ApplicationController
  ...
  def faq
    ...
    @questions = [
      ...
      { question: "What software does this site use?", answer: "The site uses on Ruby (1.9.3) on Rails (2.3.11) with Twitter's <a href=\"http://twitter.github.com/bootstrap/\" target=\"_blank\">Bootstrap</a> framework as the CSS/JS foundation.".html_safe },
      { section: "what", question: "What information can other people see?", answer: "People in our awesome software section can see all of your answers. Nobody else can. Nobody can see your email address, although anyone can look it up easily in the HP directory." },
      ...
      { question: "When can I change my answers?", answer: "Right <a href=\"#{root_path}\" title=\"Synergize\">now</a>.".html_safe },
      ...
      { question: "How is data pulled back out of the system?", answer: "Currently, only CSV export is supported. The CSV format imports directly into Excel."},
      ...
      { question: "How do I sign in?", answer: "No need. Sign in is for ecosystems where organisms don't trust each other.".html_safe},
